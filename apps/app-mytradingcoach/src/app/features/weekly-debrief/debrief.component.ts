        ...
        @if (isGenerating()) {
          <div class="generating-state">
            ...
            <p class="generating-desc">
              L'IA analyse tes trades, émotions et patterns de la semaine.
            </p>
          </div>
        } @else if (isLoading()) {
          ...
          <div class="empty-state">
            ...
            <small
              >Clique sur "Générer le débrief" pour créer ton rapport IA</small
            >
            <small
              >Les debriefs sont générés automatiquement chaque dimanche à
              23h</small
            >
          </div>
        } @else {
          ...
          <div class="debrief-header">
            <div>
              ...
              <div class="week-meta">
                ...
                {{ debrief()!.endDate | date: 'd MMM yyyy' }} · Généré le
          ...
          <div class="stats-row">
            ...
            <div class="stat-card">
              ...
              <div
                ...
                [class.text-red]="
                  debrief()!.stats.winRate > 0 && debrief()!.stats.winRate < 50
                "
            ...
            <div class="stat-card">
              ...
              <div
                class="stat-value"
                [class.text-green]="debrief()!.stats.totalPnl >= 0"
                [class.text-red]="debrief()!.stats.totalPnl < 0"
              >
          ...
          @if (debrief()!.insights.emotionInsight) {
            <div class="emotion-block">
              ...
              <p class="ai-summary-text">
                {{ debrief()!.insights.emotionInsight }}
              </p>
            </div>
          }
...
export class DebriefComponent {
  ...
  generateDebrief() {
    ...
    this.error.set(null);
    this.http
      .post<{ data: WeeklyDebrief }>(
        `${environment.apiUrl}/debrief/generate`,
        {},
      )
      .pipe(takeUntilDestroyed(this.destroyRef))
      .subscribe({
        ...
        error: (err) => {
          this.error.set(
            err.error?.message ?? 'Erreur lors de la génération du débrief',
          );
          this.isGenerating.set(false);
        },
      });
