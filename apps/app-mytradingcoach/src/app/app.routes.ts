...
export const appRoutes: Routes = [
  {
    ...
    data: {
      seo: {
        title: 'Connexion',
        description: 'Connectez-vous à MyTradingCoach pour accéder à votre journal de trading intelligent.',
        noindex: false,
      },
    },
    loadComponent: () =>
  ...
  },
  {
    ...
    data: {
      seo: {
        ...
        description: "Créez votre compte MyTradingCoach gratuitement et commencez à analyser vos trades avec l'IA.",
        noindex: false,
      },
    },
    loadComponent: () =>
