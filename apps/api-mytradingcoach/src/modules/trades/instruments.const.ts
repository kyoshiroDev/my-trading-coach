...
export const INSTRUMENTS: Instrument[] = [
  ...
  { symbol: 'MNQ',  label: 'Micro E-mini Nasdaq (MNQ)',        category: 'FUTURES_US', tickValue: 0.50,   tickSize: 0.25       },
  { symbol: 'NQ',   label: 'E-mini Nasdaq (NQ)',               category: 'FUTURES_US', tickValue: 5.00,   tickSize: 0.25       },
  { symbol: 'MES',  label: 'Micro E-mini S&P 500 (MES)',       category: 'FUTURES_US', tickValue: 1.25,   tickSize: 0.25       },
  { symbol: 'ES',   label: 'E-mini S&P 500 (ES)',              category: 'FUTURES_US', tickValue: 12.50,  tickSize: 0.25       },
  { symbol: 'MYM',  label: 'Micro E-mini Dow Jones (MYM)',     category: 'FUTURES_US', tickValue: 0.50,   tickSize: 1.0        },
  { symbol: 'YM',   label: 'E-mini Dow Jones (YM)',            category: 'FUTURES_US', tickValue: 5.00,   tickSize: 1.0        },
  { symbol: 'M2K',  label: 'Micro E-mini Russell 2000 (M2K)', category: 'FUTURES_US', tickValue: 0.50,   tickSize: 0.1        },
  { symbol: 'RTY',  label: 'E-mini Russell 2000 (RTY)',        category: 'FUTURES_US', tickValue: 5.00,   tickSize: 0.1        },
  // ── Energy ───────────────────────────────────────────────────────────────
  { symbol: 'MCL',  label: 'Micro WTI Crude Oil (MCL)',        category: 'FUTURES_US', tickValue: 1.00,   tickSize: 0.01       },
  { symbol: 'CL',   label: 'WTI Crude Oil (CL)',               category: 'FUTURES_US', tickValue: 10.00,  tickSize: 0.01       },
  // ── Metals ───────────────────────────────────────────────────────────────
  { symbol: 'MGC',  label: 'Micro Gold (MGC)',                  category: 'FUTURES_US', tickValue: 1.00,   tickSize: 0.1        },
  { symbol: 'GC',   label: 'Gold (GC)',                        category: 'FUTURES_US', tickValue: 10.00,  tickSize: 0.1        },
  { symbol: 'SIL',  label: 'Micro Silver (SIL)',               category: 'FUTURES_US', tickValue: 1.25,   tickSize: 0.005      },
  { symbol: 'SI',   label: 'Silver (SI)',                      category: 'FUTURES_US', tickValue: 25.00,  tickSize: 0.005      },
  // ── Bonds ────────────────────────────────────────────────────────────────
  ...
  // ── Currency Futures ──────────────────────────────────────────────────────
  { symbol: '6E',   label: 'Euro FX Futures (6E)',              category: 'FUTURES_US', tickValue: 6.25,   tickSize: 0.00005    },
  { symbol: 'M6E',  label: 'Micro Euro FX Futures (M6E)',       category: 'FUTURES_US', tickValue: 1.25,   tickSize: 0.0001     },
  { symbol: '6B',   label: 'British Pound Futures (6B)',        category: 'FUTURES_US', tickValue: 6.25,   tickSize: 0.0001     },
  { symbol: 'M6B',  label: 'Micro British Pound Futures (M6B)', category: 'FUTURES_US', tickValue: 0.625,  tickSize: 0.0001     },
  { symbol: '6J',   label: 'Japanese Yen Futures (6J)',         category: 'FUTURES_US', tickValue: 6.25,   tickSize: 0.0000005  },
  { symbol: '6C',   label: 'Canadian Dollar Futures (6C)',      category: 'FUTURES_US', tickValue: 10.00,  tickSize: 0.0001     },
  { symbol: '6S',   label: 'Swiss Franc Futures (6S)',          category: 'FUTURES_US', tickValue: 12.50,  tickSize: 0.0001     },
  { symbol: '6A',   label: 'Australian Dollar Futures (6A)',    category: 'FUTURES_US', tickValue: 10.00,  tickSize: 0.0001     },
  // ── Crypto Futures ────────────────────────────────────────────────────────
  { symbol: 'MBT',  label: 'Micro Bitcoin Futures (MBT)',       category: 'FUTURES_US', tickValue: 5.00,   tickSize: 5.0        },
  { symbol: 'BTC',  label: 'Bitcoin Futures (BTC)',             category: 'FUTURES_US', tickValue: 25.00,  tickSize: 5.0        },
  { symbol: 'MET',  label: 'Micro Ether Futures (MET)',         category: 'FUTURES_US', tickValue: 0.10,   tickSize: 0.1        },
  // ── CRYPTO ───────────────────────────────────────────────────────────────
